...
def create_team():
    ...
    for name in monster_data:
        player = Monster()
        player.name = name
        player.x = monster_data[name]['x']
        player.y = monster_data[name]['y']
        player.state = player_state_table[monster_data[name]['StartState']]
        monster.append(player)
